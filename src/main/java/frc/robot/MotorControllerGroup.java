 ...
 *
 * Use {@link PWMMotorController#addFollower(PWMMotorController)} or if using CAN motor
...
public class MotorControllerGroup implements MotorController, Sendable, AutoCloseable {
  ...
  /**
1   * Create a new MotorControllerGroup with the provided MotorControllers.
   *
   * @param motorControllers The MotorControllers to add.
4   */
  @SuppressWarnings("this-escape")
